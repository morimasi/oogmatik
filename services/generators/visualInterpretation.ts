...
export class VisualInterpretationGenerator extends BaseGenerator {
    constructor() {
        super(ActivityType.VISUAL_INTERPRETATION, {
                ...
                blocks: [
                    {
                        type: 'image',
                        content: {
                            prompt: 'A detailed illustration of a busy city park with children playing, a dog chasing a ball, and an ice cream vendor.',
                    ...
                    },
                    {
                        ...
                        content: {
                            items: [
                                ...
                                { q: 'Dondurmacının şemsiyesi ne renk?', type: 'multiple', options: ['Kırmızı', 'Mavi', 'Sarı'] }
                            ]
                        }
                    }
                ]
