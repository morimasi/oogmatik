...
export const HiddenPasswordConfig = ({ options, onChange }: { options: GeneratorOptions; onChange: (k: string, v: any) => void }) => {
    return (
            ...
            <div className="p-5 bg-zinc-50 dark:bg-zinc-800 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-700 space-y-4 shadow-inner">
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                        ...
                        <select value={options.gridSize || 5} onChange={(e: any) => onChange('gridSize', Number(e.target.value))} className="w-full p-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-xs font-bold">
                    ...
                    <div className="space-y-1">
                        ...
                        <input type="number" min={1} max={12} value={options.itemCount || 9} onChange={(e: any) => onChange('itemCount', Number(e.target.value))} className="w-full p-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-xs font-bold" />
                    </div>
                </div>
