...
export const SheetRenderer = React.memo(({ activityType, data, studentProfile, settings }: SheetRendererProps) => {
    ...
    switch (activityType) {
        ...
        case ActivityType.APARTMENT_LOGIC_PUZZLE: return <ApartmentLogicSheet data={data as any} />;
        case ActivityType.FINANCIAL_MARKET_CALCULATOR: return <FinancialMarketSheet data={data as any} />;
        ...
        case ActivityType.FIVE_W_ONE_H: return <FiveWOneHSheet data={data as any} />;
        case ActivityType.COLORFUL_SYLLABLE_READING: return <ColorfulSyllableReadingSheet data={data as any} />;
        ...
        case ActivityType.FAMILY_TREE_MATRIX: return <FamilyTreeMatrixSheet data={data as any} />;
        ...
        case ActivityType.DIRECTIONAL_CODE_READING: return <DirectionalCodeReadingSheet data={data as any} />;
        case ActivityType.LOGIC_ERROR_HUNTER: return <LogicErrorHunterSheet data={data as any} />;
        case ActivityType.PATTERN_COMPLETION: return <PatternCompletionSheet data={data as any} />;
