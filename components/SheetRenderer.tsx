...
export const SheetRenderer = React.memo(({ activityType, data }: SheetRendererProps) => {
    // Safety check: if data is null/undefined, don't render and let ErrorBoundary handle it or return null
    if (!data) return null;
    ...
    switch (activityType) {
        ...
        default:
            return <div>Bu etkinlik türü henüz desteklenmiyor: {activityType}</div>;
    }
});
