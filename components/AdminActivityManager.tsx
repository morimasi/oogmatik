                                        ...
                                        <>
                                            ...
                                            <div className="grid grid-cols-2 gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" list="cat-suggestions" value={editingActivity.category} onChange={e => setEditingActivity({...editingActivity, category: e.target.value})} className="w-full p-3 border-2 border-zinc-200 dark:border-zinc-700 rounded-xl bg-transparent focus:border-indigo-500 outline-none" />
