...
const offlineGeneratorMap: { [key in ActivityType]?: (options: offlineGenerators.OfflineGeneratorOptions) => Promise<WorksheetData> } = {
    ...
    [ActivityType.SHAPE_NUMBER_PATTERN]: offlineGenerators.generateOfflineShapeNumberPattern,
    [ActivityType.GRID_DRAWING]: offlineGenerators.generateOfflineGridDrawing,
    [ActivityType.COLOR_WHEEL_MEMORY]: offlineGenerators.generateOfflineColorWheelMemory,
    [ActivityType.IMAGE_COMPREHENSION]: offlineGenerators.generateOfflineImageComprehension,
    [ActivityType.CHARACTER_MEMORY]: offlineGenerators.generateOfflineCharacterMemory,
    [ActivityType.STORY_SEQUENCING]: offlineGenerators.generateOfflineStorySequencing,
    [ActivityType.CHAOTIC_NUMBER_SEARCH]: offlineGenerators.generateOfflineChaoticNumberSearch,
    [ActivityType.BLOCK_PAINTING]: offlineGenerators.generateOfflineBlockPainting,
    [ActivityType.MINI_WORD_GRID]: offlineGenerators.generateOfflineMiniWordGrid,
    [ActivityType.VISUAL_ODD_ONE_OUT]: offlineGenerators.generateOfflineVisualOddOneOut,
    [ActivityType.SHAPE_COUNTING]: offlineGenerators.generateOfflineShapeCounting,
    ...
    [ActivityType.DOT_PAINTING]: offlineGenerators.generateOfflineDotPainting,
    ...
    [ActivityType.HOMONYM_SENTENCE_WRITING]: offlineGenerators.generateOfflineHomonymSentenceWriting,
    [ActivityType.WORD_GRID_PUZZLE]: offlineGenerators.generateOfflineWordGridPuzzle,
    [ActivityType.PROVERB_SAYING_SORT]: offlineGenerators.generateOfflineProverbSayingSort,
    [ActivityType.HOMONYM_IMAGE_MATCH]: offlineGenerators.generateOfflineHomonymImageMatch,
    [ActivityType.ANTONYM_FLOWER_PUZZLE]: offlineGenerators.generateOfflineAntonymFlowerPuzzle,
    [ActivityType.PROVERB_WORD_CHAIN]: offlineGenerators.generateOfflineProverbWordChain,
    [ActivityType.THEMATIC_ODD_ONE_OUT]: offlineGenerators.generateOfflineThematicOddOneOut,
    [ActivityType.SYNONYM_ANTONYM_GRID]: offlineGenerators.generateOfflineSynonymAntonymGrid,
    [ActivityType.PUNCTUATION_COLORING]: offlineGenerators.generateOfflinePunctuationColoring,
    [ActivityType.PUNCTUATION_MAZE]: offlineGenerators.generateOfflinePunctuationMaze,
    [ActivityType.ANTONYM_RESFEBE]: offlineGenerators.generateOfflineAntonymResfebe,
    [ActivityType.THEMATIC_WORD_SEARCH_COLOR]: offlineGenerators.generateOfflineThematicWordSearchColor,
    [ActivityType.THEMATIC_ODD_ONE_OUT_SENTENCE]: offlineGenerators.generateOfflineThematicOddOneOutSentence,
    [ActivityType.PROVERB_SENTENCE_FINDER]: offlineGenerators.generateOfflineProverbSentenceFinder,
    [ActivityType.SYNONYM_SEARCH_STORY]: offlineGenerators.generateOfflineSynonymSearchAndStory,
    [ActivityType.COLUMN_ODD_ONE_OUT_SENTENCE]: offlineGenerators.generateOfflineColumnOddOneOutSentence,
    [ActivityType.SYNONYM_ANTONYM_COLORING]: offlineGenerators.generateOfflineSynonymAntonymColoring,
    [ActivityType.PUNCTUATION_PHONE_NUMBER]: offlineGenerators.generateOfflinePunctuationPhoneNumber,
    [ActivityType.PUNCTUATION_SPIRAL_PUZZLE]: offlineGenerators.generateOfflinePunctuationSpiralPuzzle,
    [ActivityType.THEMATIC_JUMBLED_WORD_STORY]: offlineGenerators.generateOfflineThematicJumbledWordStory,
    [ActivityType.SYNONYM_MATCHING_PATTERN]: offlineGenerators.generateOfflineSynonymMatchingPattern,
    [ActivityType.FUTOSHIKI]: offlineGenerators.generateOfflineFutoshiki,
    [ActivityType.NUMBER_PYRAMID]: offlineGenerators.generateOfflineNumberPyramid,
    [ActivityType.NUMBER_CAPSULE]: offlineGenerators.generateOfflineNumberCapsule,
    [ActivityType.ODD_EVEN_SUDOKU]: offlineGenerators.generateOfflineOddEvenSudoku,
    [ActivityType.ROMAN_NUMERAL_CONNECT]: offlineGenerators.generateOfflineRomanNumeralConnect,
    [ActivityType.ROMAN_NUMERAL_STAR_HUNT]: offlineGenerators.generateOfflineRomanNumeralStarHunt,
    [ActivityType.ROUNDING_CONNECT]: offlineGenerators.generateOfflineRoundingConnect,
    [ActivityType.ROMAN_NUMERAL_MULTIPLICATION]: offlineGenerators.generateOfflineRomanNumeralMultiplication,
    [ActivityType.ARITHMETIC_CONNECT]: offlineGenerators.generateOfflineArithmeticConnect,
    [ActivityType.ROMAN_ARABIC_MATCH_CONNECT]: offlineGenerators.generateOfflineRomanArabicMatchConnect,
    [ActivityType.SUDOKU_6X6_SHADED]: offlineGenerators.generateOfflineSudoku6x6Shaded,
    [ActivityType.KENDOKU]: offlineGenerators.generateOfflineKendoku,
    ...
    [ActivityType.OPERATION_SQUARE_SUBTRACTION]: offlineGenerators.generateOfflineOperationSquareSubtraction,
    [ActivityType.OPERATION_SQUARE_FILL_IN]: offlineGenerators.generateOfflineOperationSquareFillIn,
    ...
    [ActivityType.OPERATION_SQUARE_MULT_DIV]: offlineGenerators.generateOfflineOperationSquareMultDiv,
    [ActivityType.SHAPE_SUDOKU]: offlineGenerators.generateOfflineShapeSudoku,
    [ActivityType.WEIGHT_CONNECT]: offlineGenerators.generateOfflineWeightConnect,
    [ActivityType.RESFEBE]: offlineGenerators.generateOfflineResfebe,
    [ActivityType.FUTOSHIKI_LENGTH]: offlineGenerators.generateOfflineFutoshikiLength,
    [ActivityType.MATCHSTICK_SYMMETRY]: offlineGenerators.generateOfflineMatchstickSymmetry,
    [ActivityType.WORD_WEB]: offlineGenerators.generateOfflineWordWeb,
    [ActivityType.STAR_HUNT]: offlineGenerators.generateOfflineStarHunt,
    [ActivityType.LENGTH_CONNECT]: offlineGenerators.generateOfflineLengthConnect,
    [ActivityType.VISUAL_NUMBER_PATTERN]: offlineGenerators.generateOfflineVisualNumberPattern,
    [ActivityType.MISSING_PARTS]: offlineGenerators.generateOfflineMissingParts,
    [ActivityType.PROFESSION_CONNECT]: offlineGenerators.generateOfflineProfessionConnect,
    [ActivityType.VISUAL_ODD_ONE_OUT_THEMED]: offlineGenerators.generateOfflineVisualOddOneOutThemed,
    [ActivityType.LOGIC_GRID_PUZZLE]: offlineGenerators.generateOfflineLogicGridPuzzle,
    [ActivityType.IMAGE_ANAGRAM_SORT]: offlineGenerators.generateOfflineImageAnagramSort,
    [ActivityType.ANAGRAM_IMAGE_MATCH]: offlineGenerators.generateOfflineAnagramImageMatch,
    [ActivityType.SYLLABLE_WORD_SEARCH]: offlineGenerators.generateOfflineSyllableWordSearch,
    [ActivityType.WORD_SEARCH_WITH_PASSWORD]: offlineGenerators.generateOfflineWordSearchWithPassword,
