            ...
            <div className="flex-1 space-y-3">
              <div className="flex gap-2 flex-wrap">
                {word.syllables.map((_, sIdx) => (
                  <div
                    key={sIdx}
                    className="w-14 h-12 border-b-[4px] border-dashed border-zinc-300 bg-zinc-50/50 rounded-t-xl flex items-center justify-center font-black text-2xl text-zinc-200"
                  >
                    ?
                  </div>
                ))}
