  ...
  <div className="flex flex-col bg-white font-lexend p-2 overflow-visible">
    ...
    <div className="grid grid-cols-2 gap-6 mt-8">
      {(data.pairs || []).map((pair, idx) => (
        <EditableElement
          key={idx}
          className="p-6 border-2 border-zinc-100 rounded-[2.5rem] flex items-center gap-6 bg-white shadow-sm hover:border-indigo-300 transition-all break-inside-avoid"
        >
