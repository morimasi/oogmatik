    ...
    return (
        <div className="w-full h-full p-8 print:p-3 flex flex-col bg-white overflow-hidden text-zinc-900 print:p-0 print:border-none border border-zinc-200">
            ...
            <div className="flex-1 flex flex-col gap-6">
                ...
                {/* YÖNERGE & OKUMA METNİ */}
                <div className="w-full bg-zinc-50 border-2 border-zinc-200 rounded-[2rem] p-6 shadow-sm relative page-break-inside-avoid">
                    <div className="absolute top-0 right-6 -translate-y-1/2 bg-yellow-100 border-2 border-yellow-300 text-yellow-800 px-4 py-1.5 rounded-full text-xs font-black shadow-sm flex items-center gap-2">
                        <i className="fa-solid fa-triangle-exclamation"></i>
                        Bu metinde tam {errors.length} adet mantık hatası var!
                    </div>

                    <h3 className="text-sm font-black text-zinc-400 tracking-widest uppercase mb-4">Okuma Metni</h3>
                ...
                <div className="flex-1 mt-4">
                    <h3 className="text-sm font-black text-fuchsia-800 tracking-widest uppercase mb-4 flex items-center gap-2">
                        <i className="fa-solid fa-clipboard-check"></i> Tespit Raporu
                    </h3>

                    <div className="space-y-4">
                        {errors.map((error, idx) => (
                            <div key={idx} className="w-full bg-white border-2 border-fuchsia-100 rounded-2xl p-4 shadow-sm flex gap-4 page-break-inside-avoid relative overflow-hidden">
                                {/* Sol Numara */}
                                ...
                                {/* Form Alanları */}
                                <div className="flex-1 grid grid-cols-[1fr_1.5fr] gap-6">
                                    {/* Hata Nedir */}
            ...
            <div className="pt-4 mt-auto border-t-2 border-zinc-100 flex flex-col gap-2">
                ...
                <div className="text-[6px] font-mono text-zinc-300 leading-tight flex gap-4 text-justify print:opacity-50 line-clamp-2">
                    {errors.map((e, i) => (
