...
export const TargetSearchSheet = ({ data }: { data: TargetSearchData }) => (
    <div className="font-lexend p-2">
        ...
        <div className="mt-8 print:mt-2 flex justify-center gap-6 print:gap-2">
            <div className="flex items-center gap-4 print:gap-1 bg-zinc-900 text-white px-6 print:px-2 py-3 rounded-2xl shadow-lg border-2 border-white">
