...
export const OddOneOutSheet = ({ data }: { data: OddOneOutData }) => (
    <div className="flex flex-col font-lexend">
        ...
        <div className="space-y-6 mt-6">
            {(data?.groups || []).map((g, i) => (
                <EditableElement key={i} className="border-2 border-zinc-100 p-8 print:p-3 rounded-[2.5rem] flex gap-8 print:p-3 justify-center flex-wrap items-center bg-white shadow-sm break-inside-avoid hover:border-indigo-200 transition-all group">
