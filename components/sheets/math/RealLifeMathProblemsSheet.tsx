                ...
                <EditableElement key={index} className="border-b-2 border-zinc-100 pb-8 print:pb-2 break-inside-avoid flex flex-col gap-4 print:gap-1 group">
                    <div className="flex gap-6 print:gap-2">
                        ...
                        <div className="flex-1">
                            <div className="text-xl font-bold text-zinc-800 leading-relaxed text-justify mb-6 print:mb-2">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 print:gap-2 ml-16">
                        <div className="flex-1 h-32 border-2 border-zinc-200 border-dashed rounded-[2rem] p-4 print:p-1 text-[10px] font-black text-zinc-300 uppercase tracking-[0.3em] flex items-start justify-center bg-zinc-50/30">Çözüm Alanı</div>
                        <div className="w-48 h-32 border-2 border-indigo-200 border-dashed rounded-[2rem] p-4 print:p-1 text-[10px] font-black text-indigo-300 uppercase tracking-[0.3em] flex items-start justify-center bg-indigo-50/30">Sonuç</div>
                    </div>
                </EditableElement>
            ))}
        </div>
