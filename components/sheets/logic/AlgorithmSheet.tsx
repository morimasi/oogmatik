...
const StepShape = ({ step }: { step: AlgorithmStep }) => {
    let shapeClass = "border-[3px] p-6 print:p-2 shadow-md transition-all hover:scale-[1.03] duration-500 min-h-[80px]";
    let icon = "fa-gear";
    let colorClass = "border-zinc-800 bg-white text-zinc-900";

    switch (step.type) {
        case 'start':
            shapeClass += " rounded-full px-12 print:px-3";
            icon = "fa-play";
    ...
    return (
        <div className="flex flex-col items-center w-full max-w-lg group">
            <EditableElement className={`${shapeClass} ${colorClass} flex items-center gap-6 print:gap-2 w-full relative overflow-visible`}>
                ...
                {step.type === 'decision' && (
                    <div className="absolute -right-20 top-1/2 -translate-y-1/2 flex flex-col items-start gap-4 print:gap-1 no-print">
...
export const AlgorithmSheet = ({ data }: { data: AlgorithmData }) => {
        ...
        <div className="h-full  flex flex-col text-black font-lexend p-2 overflow-visible">
            ...
            <div className="mb-12 print:mb-3 p-10 print:p-3 print:p-4 print:p-1 bg-zinc-900 text-white rounded-[4rem] shadow-2xl relative overflow-hidden border-4 border-white ring-2 ring-zinc-100">
                ...
                <div className="relative z-10">
                    <h4 className="text-[11px] font-black uppercase text-indigo-400 mb-4 print:mb-1 tracking-[0.5em] flex items-center gap-3">
            ...
            <div className="flex-1 flex flex-col items-center gap-0 relative py-8 print:py-2 w-full max-w-3xl mx-auto">
                {steps.length > 0 ? (
                    ...
                    <div className="p-20 print:p-4 text-center border-4 border-dashed border-zinc-100 rounded-[3rem] w-full">
                        <i className="fa-solid fa-triangle-exclamation text-amber-500 text-5xl mb-4 print:mb-1"></i>
            ...
            <div className="mt-16 print:mt-4 p-10 print:p-3 print:p-4 print:p-1 bg-zinc-50 border-[3px] border-zinc-200 border-dashed rounded-[4rem] text-center relative overflow-hidden break-inside-avoid">
                <h4 className="text-xs font-black text-zinc-400 uppercase mb-8 print:mb-2 tracking-[0.3em] flex items-center justify-center gap-4 print:gap-1">
                    <div className="h-0.5 w-12 bg-zinc-200"></div>
                    AKILLI ÇÖZÜM VE ANALİZ ALANI
                    <div className="h-0.5 w-12 bg-zinc-200"></div>
                </h4>
                <div className="grid grid-cols-2 gap-10 print:gap-3 print:gap-4 print:gap-1 print:p-4 print:p-1 min-h-[200px]">
