...
export const BrainTeasersSheet: React.FC<BrainTeasersSheetProps> = ({ data, settings }) => {
  ...
  return (
    <div
      className="w-full h-full flex flex-col gap-8 print:gap-3 print:p-3 p-8 print:p-3"
    ...
    >
      ...
      {/* Puzzles Grid */}
      <div className="grid grid-cols-1 gap-8 print:gap-3 print:p-3">
            ...
            <div className="p-8 print:p-3">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3
                    className="text-2xl font-bold text-zinc-800 leading-relaxed mb-6"
