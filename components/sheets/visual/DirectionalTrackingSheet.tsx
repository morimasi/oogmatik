...
>>>>>>> 7ddd6a5ed99eef0e234e449bd0286508a88609b4
            ...
            <div className={`grid ${gridCols} gap-8 print:gap-2 print:gap-3 print:p-3 mt-10 print:mt-3 flex-1 content-start items-start pb-20 print:pb-4`}>
                {puzzles.map((puzzle, idx) => (
                    <EditableElement
                        key={idx}
                        className="flex flex-col border-2 border-zinc-100 rounded-[3rem] bg-zinc-50/50 group p-6 print:p-2 relative overflow-visible shadow-sm break-inside-avoid hover:bg-white hover:border-indigo-200 hover:shadow-xl transition-all"
                    >
                        {/* Bulmaca Başlığı */}
                        ...
                        <div className="flex flex-col gap-8 print:gap-2 print:gap-3 print:p-3">
                            ...
                            <div className="bg-zinc-900 border-2 border-white rounded-[2rem] p-6 print:p-2 shadow-2xl relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-10 -mt-10 print:mt-3"></div>
                                <div className="flex items-center gap-3 mb-5 print:mb-1 pb-3 border-b border-white/10">
                            ...
                            <div className="flex gap-10 print:gap-3 print:gap-4 print:gap-1 print:p-4 print:p-1 items-start">
                                ...
                                <div className="relative shrink-0">
                                    <div className="p-3 bg-white border-2 border-zinc-200 rounded-[2.5rem] shadow-xl overflow-visible relative ring-8 ring-zinc-50">
                                        ...
                                        {/* Başlangıç Vektörü */}
                                        <div className="absolute -bottom-3 right-6 px-4 print:px-1 py-1 bg-amber-400 text-black rounded-xl text-[8px] font-black uppercase tracking-widest shadow-lg border-2 border-white">
                                ...
                                <div className="flex-1 flex flex-col pt-6 print:pt-2">
                                    <div className="flex flex-col mb-8 print:mb-2">
                                    ...
                                    {settings?.showClinicalNotes && puzzle.clinicalMeta && (
                                        <div className="mt-auto space-y-3 bg-zinc-100/50 p-4 print:p-1 rounded-3xl border border-zinc-100">
