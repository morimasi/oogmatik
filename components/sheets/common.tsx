    ...
    <div className="pedagogical-header mb-6 w-full break-inside-avoid border-b-4 border-zinc-900 pb-4 print:mb-8 print:pb-2 print:border-b-2">
        <div className="flex items-start justify-between gap-6 print:gap-2">
            <div className="flex-1">
                ...
                <p className="instruction text-base font-bold text-zinc-700 leading-normal italic print:text-[10px] print:leading-tight">{instruction}</p>
            </div>
            {data?.targetedErrors && (
        ...
        {note && <p className="note mt-3 text-[10px] text-zinc-500 font-medium leading-relaxed max-w-3xl print:mt-1 print:text-[8px] print:leading-tight">
