        ...
        <div className="h-full print:h-0 flex flex-col text-black font-lexend">
            ...
            <div className={`grid ${gridCols} gap-x-6 gap-y-8 mt-2 flex-1 content-start`}>
                {(data.puzzles || []).map((puzzle: any, pIdx) => {
                    ...
                    return (
                        <EditableElement key={pIdx} className={`flex flex-col border-[3px] border-zinc-900 rounded-[2.5rem] p-6 print:p-2 bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,0.08)] break-inside-avoid relative group hover:border-indigo-600 transition-all duration-300 ${cardSize}`}>
                            {/* Numara İkonu */}
                            ...
                            <div className="mb-4 print:mb-1 flex-1">
                            ...
                            <div className="grid grid-cols-5 gap-1.5 mb-4 print:mb-1">
            ...
            <div className="mt-10 print:mt-3 mb-6 print:mb-2 break-inside-avoid shrink-0">
                <EditableElement className="bg-zinc-900 text-white p-8 print:p-2 print:p-3 rounded-[3.5rem] shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 print:gap-2 print:gap-3 print:p-3 border-4 border-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>

                    <div className="flex-1 text-center md:text-left relative z-10">
                        <div className="flex items-center gap-4 print:gap-1 mb-3 justify-center md:justify-start">
                    ...
                    <div className="flex items-center gap-10 print:gap-3 print:gap-4 print:gap-1 print:p-4 print:p-1 bg-white/10 p-6 print:p-2 rounded-[2.5rem] border border-white/20 backdrop-blur-xl relative z-10">
