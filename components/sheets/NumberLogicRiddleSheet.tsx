    ...
    return (
        <div className="h-full flex flex-col text-black font-lexend">
            ...
            <div className="mt-10 mb-6 break-inside-avoid shrink-0">
                <EditableElement className="bg-zinc-900 text-white p-8 print:p-3 rounded-[3.5rem] shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 print:gap-3 print:p-3 border-4 border-white relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-10 print:gap-4 print:p-4 bg-white/10 p-6 rounded-[2.5rem] border border-white/20 backdrop-blur-xl relative z-10">
