...
const Worksheet: React.FC<WorksheetProps> = ({ activityType, data, settings }) => {
    ...
    const renderContent = (singleData: SingleWorksheetData, index: number) => {
        switch (activityType) {
            ...
            case ActivityType.FUTOSHIKI_LENGTH: return <MathLogicSheets.FutoshikiSheet data={singleData as FutoshikiLengthData} />;
            case ActivityType.NUMBER_PYRAMID: return <MathLogicSheets.NumberPyramidSheet data={singleData as NumberPyramidData} />;
            case ActivityType.DIVISION_PYRAMID: return <MathLogicSheets.NumberPyramidSheet data={singleData as DivisionPyramidData} />;
            case ActivityType.MULTIPLICATION_PYRAMID: return <MathLogicSheets.NumberPyramidSheet data={singleData as MultiplicationPyramidData} />;
            ...
            case ActivityType.SUDOKU_6X6_SHADED: return <MathLogicSheets.OddEvenSudokuSheet data={singleData as Sudoku6x6ShadedData} />;
