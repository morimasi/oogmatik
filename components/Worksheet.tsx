...
const Worksheet: React.FC<WorksheetProps> = ({ activityType, data, settings }) => {
    ...
    const renderContent = (singleData: SingleWorksheetData, index: number) => {
        switch (activityType) {
            ...
            case ActivityType.ANAGRAM: return <WordGameSheets.AnagramSheet data={singleData as AnagramData[]} />;
            ...
            case ActivityType.LETTER_GRID_WORD_FIND: return <WordGameSheets.LetterGridWordFindSheet data={singleData as LetterGridWordFindData} />;
