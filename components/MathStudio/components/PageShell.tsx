...
import { A4_WIDTH_PX, A4_HEIGHT_PX, ThemeConfig, PAPER_THEMES, FONT_THEMES, DEFAULT_THEME_CONFIG } from '../constants';
...
export const PageShell: React.FC<PageShellProps> = ({
    ...
    return (
        <div
            className={`math-canvas-page shadow-2xl relative flex flex-col origin-top ${karneClass}`}
            style={{
        ...
        >
            ...
            <div className="pb-2 mb-3" style={{ borderBottom: `2px solid ${paper.border}` }}>
                <div className="flex justify-between items-center">
                    <h1 className="text-xl font-black uppercase tracking-tight leading-none" style={{ color: paper.text }}>
                        <EditableText value={pageConfig.title} />
                    </h1>
                    <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-wider" style={{ color: paper.text, opacity: 0.5 }}>
                        {pageConfig.showName && (
            ...
            {/* FOOTER — thin line */}
            <div className="mt-3 pt-1.5 flex justify-between items-center text-[9px] font-mono uppercase" style={{ borderTop: `1px solid ${paper.border}30`, color: paper.text, opacity: 0.4 }}>
