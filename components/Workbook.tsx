...
const Workbook: React.FC<WorkbookProps> = ({ items, settings }) => {
    ...
    const renderCover = () => {
        ...
        if (settings.theme === 'modern') {
            return (
                <div className="worksheet-page relative flex flex-col p-0 shadow-2xl mb-8 bg-white overflow-hidden"
                    style={{ width: '210mm', minHeight: '297mm', margin: '0 auto', borderLeft: `20mm solid ${accent}`, backgroundColor: 'white', color: 'black', colorScheme: 'light' as any }}>
        ...
        return (
            <div className="worksheet-page relative flex flex-col justify-center items-center p-16 shadow-2xl mb-8 bg-white"
                style={{ width: '210mm', minHeight: '297mm', margin: '0 auto', backgroundColor: 'white', color: 'black', colorScheme: 'light' as any }}>
    ...
    const renderDividerPage = (item: CollectionItem, index: number) => {
        return (
            <div className="worksheet-page relative flex flex-col justify-center items-center p-16 shadow-2xl mb-8"
                style={{ width: '210mm', minHeight: '297mm', margin: '0 auto', backgroundColor: '#18181b', color: 'white', colorScheme: 'light' as any }}>
            ...
            {items.map((item, index) => {
                ...
                return (
                    <div key={item.id} className="relative mb-8 w-full flex justify-center">
                        <div className="relative bg-white shadow-2xl worksheet-page" style={{ width: '210mm', minHeight: '297mm', backgroundColor: 'white', color: 'black', colorScheme: 'light' as any }}>
                            <Watermark />
