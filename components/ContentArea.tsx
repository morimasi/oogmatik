        ...
        <>
            ...
            {error && !error.startsWith("Bilgi:") && (
                <div className="flex justify-center items-center h-full p-4">
                    <div className="bg-[var(--bg-paper)] border-2 border-red-500/30 rounded-2xl shadow-xl max-w-lg w-full overflow-hidden">
                        ...
                        <div className="p-8 text-center">
                            ...
                            <div className="flex flex-col gap-3">
                                <button 
                                    ...
                                    className="w-full bg-[var(--accent-color)] text-black hover:bg-[var(--accent-hover)] font-bold py-3 px-4 rounded-xl transition-colors"
                                >
                                    Ayarlara Dön
                                </button>
                            </div>
            ...
            {!isLoading && !error && !worksheetData && (
                 <div className="flex flex-col items-center h-full relative min-h-[500px] animate-in fade-in duration-500 w-full justify-center">
                    <div className="absolute inset-0 overflow-hidden -z-10">
                        ...
                        <i className="fa-solid fa-puzzle-piece text-zinc-500/10 absolute text-9xl" style={{ top: '20%', right: '8%', animation: 'float 10s ease-in-out infinite 1s' }}></i>
                    </div>
                     <div className="text-center p-8 z-10 max-w-3xl bg-[var(--panel-bg)] backdrop-blur-sm rounded-3xl border border-[var(--border-color)] shadow-2xl w-full">
