...
const WelcomePlaceholder: React.FC = () => (
  <div className="flex flex-col items-center justify-center text-center h-full bg-white dark:bg-slate-800 rounded-xl shadow-lg p-10 border-2 border-dashed border-gray-300 dark:border-gray-600">
      <div className="w-24 h-24 bg-stone-100 dark:bg-slate-700 rounded-full flex items-center justify-center mb-4">
          <i className="fa-solid fa-wand-magic-sparkles fa-3x text-gray-400 dark:text-gray-500"></i>
      </div>
      <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300">Etkinlik Oluşturucuya Hoş Geldiniz!</h3>
      <p className="text-gray-500 dark:text-gray-400 mt-2 max-w-md">Başlamak için sol taraftaki menüden bir etkinlik kategorisi seçin, ayarları yapılandırın ve "Etkinlik Oluştur" düğmesine tıklayarak çalışma sayfanızı anında hazırlayın.</p>
  </div>
);
...
const ContentArea: React.FC<ContentAreaProps> = ({
  ...
  return (
    <main className="flex-1 bg-stone-50 dark:bg-slate-900 p-6 overflow-y-auto">
        ...
        <div className="mt-4">
            {isLoading ? (
                 <div className="flex items-center justify-center text-center h-full p-10">
                    <div role="status">
                        <svg aria-hidden="true" className="inline w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-indigo-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
