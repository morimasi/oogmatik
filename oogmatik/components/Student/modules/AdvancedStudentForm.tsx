  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-2xl w-full max-w-4xl mx-auto my-8 font-['Lexend'] animate-in zoom-in-95 duration-300">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          onClick={onCancel}
          className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-500 hover:text-zinc-900 dark:hover:text-white flex items-center justify-center transition-colors"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-right-8 duration-300">
            <div className="col-span-2 bg-indigo-50 dark:bg-indigo-900/10 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800/50 flex gap-3 mb-2">
              ...
              <p className="text-xs text-indigo-800 dark:text-indigo-300">
                Öğrencinin temel kimlik ve iletişim bilgilerini eksiksiz giriniz. TC Kimlik No
                faturalandırma ve resmi işlemler için gereklidir.
              </p>
            </div>
        ...
        {step === 2 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-right-8 duration-300">
            <div className="col-span-2 bg-indigo-50 dark:bg-indigo-900/10 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800/50 flex gap-3 mb-2">
              ...
              <p className="text-xs text-indigo-800 dark:text-indigo-300">
                Acil durumlarda ulaşılacak veli ve iletişim bilgilerini giriniz. Fatura bu kişiye
                kesilecektir.
              </p>
            </div>
        ...
        {step === 3 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-right-8 duration-300">
            <div className="col-span-2 bg-indigo-50 dark:bg-indigo-900/10 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800/50 flex gap-3 mb-2">
              ...
              <p className="text-xs text-indigo-800 dark:text-indigo-300">
                Öğrencinin devam ettiği örgün eğitim kurumuna dair bilgiler. RAM raporları için
                gereklidir.
              </p>
            </div>
        ...
        {step === 4 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-right-8 duration-300">
            <div className="col-span-2 bg-indigo-50 dark:bg-indigo-900/10 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800/50 flex gap-3 mb-2">
              ...
              <p className="text-xs text-indigo-800 dark:text-indigo-300">
                Varsa tıbbi tanı, RAM raporu ve sağlık durumuna ilişkin kritik bilgiler. Bu bilgiler
                BEP oluşturulurken kullanılacaktır.
              </p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {formData.diagnosis.map((d, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-lg text-sm font-bold flex items-center gap-2"
                  >
                    {d}
                    <button
        ...
        {step === 5 && (
          <div className="grid grid-cols-1 gap-6 animate-in slide-in-from-right-8 duration-300">
            <div className="bg-indigo-50 dark:bg-indigo-900/10 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800/50 flex gap-3 mb-2">
              ...
              <p className="text-xs text-indigo-800 dark:text-indigo-300">
                Öğrenciyle yapılan ilk görüşme notları, ailenin beklentileri ve sizin ilk
                izlenimleriniz.
              </p>
            </div>
