...
const SuperTurkceV2Page = lazy(() =>
  import('./pages/SuperTurkceV2Page').then((m) => ({ default: m.SuperTurkceV2Page }))
);

const PremiumStudioPage = lazy(() =>
  import('./pages/PremiumStudioPage').then((module) => ({ default: module.PremiumStudioPage }))
);
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          <Sidebar
            ...
            onOpenPremiumStudio={() => handleOpenStudio('premium_studio')}
        ...
        <div className="absolute inset-0 z-50 bg-black overflow-hidden flex flex-col">
          <Suspense fallback={<LoadingSpinner />}>
            ...
            <button
              ...
              className="absolute top-4 right-4 w-10 h-10 bg-black/50 hover:bg-black/80 text-white rounded-full flex items-center justify-center backdrop-blur-md transition-all z-[60] border border-white/10"
              title="Kapat"
            >
