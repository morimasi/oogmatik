...
const Workbook: React.FC<WorkbookProps> = ({ items, settings }) => {
  ...
  const renderCover = () => {
              ...
              <div className="p-20 z-10 flex flex-col h-full justify-between">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="px-4 py-1 bg-white text-black text-[10px] font-black tracking-widest uppercase">
                      Student Protocol
                    </div>
            ...
            <div className="w-full h-full bg-zinc-950 text-white flex flex-col relative overflow-hidden">
              ...
              <div className="p-24 h-full flex flex-col justify-center items-center text-center relative z-10">
                ...
                <div className="max-w-2xl px-10">
                  ...
                  <h2 className="text-4xl font-bold italic tracking-wide text-zinc-200">
                    {settings.studentName}
                  </h2>
                </div>
            ...
            <div className="w-full h-full bg-zinc-900 text-white flex flex-col relative overflow-hidden">
              ...
              <div className="p-20 h-full flex flex-col justify-between relative z-10">
                ...
                <div className="text-center">
                  ...
                  <p className="text-lg tracking-[0.8em] font-light opacity-60 uppercase mb-10">
                    Keşif Yolculuğu
                  </p>
            ...
            <div className="w-full h-full bg-[#fdfbf7] flex flex-col relative overflow-hidden">
              ...
              <div className="p-20 h-full flex flex-col justify-between relative z-10 border-[1px] border-zinc-100 m-8">
                <div className="flex justify-between items-center opacity-80">
                  {logo} <span className="text-zinc-300 font-mono">{settings.year}</span>
                </div>
        ...
        case 'artistic':
          return (
            <div className="w-full h-full bg-[#fcfcfc] flex flex-col relative overflow-hidden">
              <div
                className="art-brush-stroke top-0 left-0 rotate-12"
                style={{ backgroundColor: accent }}
              ></div>
              <div
                className="art-brush-stroke bottom-20 right-[-50px] -rotate-12"
              ...
              <div className="p-20 h-full flex flex-col justify-between relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <h2 className="text-4xl font-light text-zinc-600 tracking-widest uppercase">
                    {settings.studentName}
                  </h2>
                </div>
            ...
            <div className="w-full h-full bg-white flex flex-col relative overflow-hidden">
              ...
              <div className="p-24 h-full flex flex-col justify-between relative z-10">
                ...
                <div className="relative">
                  ...
                  <h2 className="text-5xl font-black text-zinc-900 mt-10 tracking-tighter">
                    {settings.studentName}
                  </h2>
                </div>
                <div className="flex justify-between items-end border-t-8 border-zinc-900 pt-10">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400">
                      STRUCTURAL LEARNING ENGINE v4.0
                    </p>
                  </div>
                  <div className="text-4xl font-black opacity-10" style={{ color: accent }}>
                    {settings.year.slice(-2)}
                  </div>
                </div>
              </div>
            </div>
        ...
        default: // Modern - baştan aşağı yenilendi
          return (
            <div
              ...
              style={{ borderLeft: `25mm solid ${accent}` }}
            >
              ...
              <div className="p-20 flex flex-col h-full justify-between relative z-10">
                <div className="flex justify-between items-start">
                  {logo}
                  <div className="text-right">
                    <h3 className="font-black text-2xl tracking-tighter" style={{ color: accent }}>
                      {settings.year}
                    </h3>
                ...
                <div className="flex flex-col items-start max-w-2xl">
                  <span
                    className="inline-block px-5 py-1.5 mb-8 text-[10px] font-black tracking-[0.2em] text-white uppercase rounded-full shadow-lg"
                    style={{ backgroundColor: accent }}
                  >
                    Premium Workbook
                  </span>
                  ...
                  <div
                    className="flex flex-col border-l-8 pl-8 py-2"
                    style={{ borderColor: accent }}
                  >
                    <p className="text-xs font-black text-zinc-400 uppercase tracking-[0.3em] mb-2">
                      Öğrenci Portfolyosu
                    </p>
                    <h2 className="text-4xl font-black text-zinc-800 tracking-tight">
                      {settings.studentName}
                    </h2>
                  </div>
                </div>
                <div className="pt-10 border-t-4 border-zinc-100">
                  <div className="flex justify-between items-end">
                    <div className="space-y-2">
                      <p className="font-black text-xl text-zinc-900 tracking-tight uppercase">
                        {settings.schoolName}
                      </p>
                    ...
                    <i
                      className="fa-solid fa-award text-4xl opacity-10"
                      style={{ color: accent }}
                    ></i>
                  </div>
                </div>
    ...
    return (
      <div
        className="worksheet-page premium-glow"
        style={getPageStyle({
          minHeight: '296.5mm', // Adjust for exact A4 height in some PDF engines
          colorScheme: 'light',
          backgroundColor:
            settings.theme === 'cyber' || settings.theme === 'luxury' || settings.theme === 'space'
              ? '#000'
              : '#fff',
        })}
      >
            ...
            {items.map((item, index) => (
              <div key={item.id} className="flex items-end justify-between group">
                <div className="flex items-center gap-4 shrink-0 max-w-[80%]">
                  <span className="font-black text-zinc-300 w-8 text-sm">
                    {item.itemType === 'divider' ? '' : index + 1}
                  </span>
                  <div className="flex flex-col">
                    <span
                      className={`text-lg font-bold truncate ${item.itemType === 'divider' ? 'uppercase tracking-widest text-xl' : ''}`}
                      style={item.itemType === 'divider' ? { color: accent } : {}}
                    >
                ...
                <span
                  className="font-black text-xl text-zinc-800"
                  style={{ color: index % 2 === 0 ? accent : 'inherit' }}
                >
  ...
  const renderDividerPage = (item: CollectionItem, index: number) => {
    return (
      <div
        className="worksheet-page flex flex-col justify-center items-center p-20 relative"
        style={getPageStyle({
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          <div
            className="w-40 h-40 rounded-[40px] flex items-center justify-center text-7xl mb-12 shadow-[0_0_50px_rgba(0,0,0,0.5)] border-t border-white/10"
          ...
          <h2 className="text-7xl font-black uppercase tracking-tighter mb-6 leading-none">
            {item.dividerConfig?.title}
          </h2>
          <div className="w-24 h-2 bg-white/20 rounded-full mb-10"></div>
          <p className="text-2xl font-light opacity-60 max-w-xl leading-relaxed italic">
            {item.dividerConfig?.subtitle}
          </p>
        </div>
      ...
      <div className="worksheet-page p-20 bg-zinc-50" style={getPageStyle()}>
        <div className="h-full border-8 border-white rounded-[40px] flex flex-col items-center justify-center text-center bg-white shadow-sm overflow-hidden relative">
          ...
          <div className="space-y-8 max-w-md relative z-10">
            <div
              className="w-32 h-32 rounded-full mx-auto flex items-center justify-center text-6xl shadow-xl transition-transform hover:scale-110 duration-500"
              style={{ backgroundColor: accent, color: 'white' }}
            >
              <i className="fa-solid fa-trophy"></i>
            </div>
            <div>
              <h2 className="text-5xl font-black text-zinc-900 mb-4 tracking-tighter">
                TEBRİKLER!
              </h2>
              ...
              <p className="text-xl font-medium text-zinc-500 leading-relaxed px-10">
                {settings.customBackCoverNote ||
                  'Bu kitapçığı tamamlayarak zihinsel becerilerinde dev bir adım attın. Başarılarının devamını dileriz!'}
              </p>
            </div>
          </div>
          <div className="absolute bottom-20 flex flex-col items-center gap-4 opacity-30 grayscale">
            {settings.logoUrl ? (
              <img src={settings.logoUrl} className="h-12 w-auto" alt="Logo" />
            ) : (
