...
const rawLibraryItems: RawLibraryItem[] = [
  {
    id: 'advanced-adhd-001',
    slug: 'magic-todo-mikro-gorev',
    title: 'Magic ToDo - Mikro Görevleyici',
    shortDescription: 'Zorlayıcı yönergeleri AI desteğiyle en küçük, yapılabilir parçalarına böler.',
    activityType: ActivityType.ALGORITHM_GENERATOR,
    category: 'dikkat-yurutucu',
    targetSkills: ['görev planlama', 'yürütücü işlev', 'zaman yönetimi'],
    ageGroups: ['11-13', '14+'],
    profiles: ['adhd', 'mixed'],
    difficultyLevels: ['Orta', 'Zor'],
    suggestedGradeRange: { min: 4, max: 9 },
  ...
  },
  {
    ...
    slug: 'dopamin-istasyonu',
    title: 'Dopamin İstasyonu (Zamanlayıcı)',
    shortDescription: 'Brain.fm/Focusmate mantığında, ritmik seslerle desteklenen kısa odak seansları ve bitiminde mikro bulmacalar.',
    activityType: ActivityType.BURDON_TEST,
    category: 'dikkat-yurutucu',
    targetSkills: ['dikkat sürdürme', 'odak yönetimi'],
  ...
  },
  {
    ...
    slug: 'rol-secici-duygu',
    title: 'Rol Seçici Duygu Dedektifi',
    shortDescription: 'Okunan cümlelerin "tonunu" belirleme ve AI ile onu öfkeli/komik/neşeli versiyonlarına çevirme.',
    activityType: ActivityType.FIND_THE_DIFFERENCE,
    category: 'yazili-anlatim',
    targetSkills: ['duygusal farkındalık', 'ton anlama'],
    ageGroups: ['11-13', '14+'],
    profiles: ['adhd', 'mixed'],
    difficultyLevels: ['Orta'],
    suggestedGradeRange: { min: 5, max: 9 },
    suggestedDuration: 20,
    formats: ['online', 'hibrit'],
    featured: false,
  ...
  },
  {
    ...
    slug: 'redaksiyon-hata-yakalayici',
    title: 'Hata Yakalayıcı (Editor Modu)',
    shortDescription: 'Kasıtlı yazım yanlışlarıyla dolu cümlelerin bulunduğu bir dedektiflik metni sunar.',
    activityType: ActivityType.LOGIC_ERROR_HUNTER,
    category: 'okuma-akiciligi',
    targetSkills: ['seçici dikkat', 'farkındalık koruma'],
    ageGroups: ['8-10', '11-13'],
    profiles: ['adhd'],
    difficultyLevels: ['Orta', 'Zor'],
    suggestedGradeRange: { min: 3, max: 7 },
    suggestedDuration: 15,
  ...
  },
  {
    ...
    slug: 'zihin-haritasi-surukle',
    title: 'Görsel Zihin Organizatörü',
    shortDescription: 'Karmaşık düşünceleri merkezden dışa sürükle-bırak mekaniğiyle mind-map üzerinde sınıflandırma.',
    activityType: ActivityType.STORY_SEQUENCING,
    category: 'dikkat-yurutucu',
    targetSkills: ['kategorizasyon', 'bilgi düzenleme'],
    ageGroups: ['11-13', '14+'],
    profiles: ['adhd', 'dyslexia'],
    difficultyLevels: ['Zor'],
    suggestedGradeRange: { min: 6, max: 9 },
  ...
  },
  {
    ...
    category: 'okuma-akiciligi',
    targetSkills: ['okuduğunu anlama', 'motivasyon'],
    ageGroups: ['5-7', '8-10'],
    profiles: ['dyslexia'],
    difficultyLevels: ['Kolay', 'Orta'],
  ...
  },
  {
    ...
    slug: 'voice-dream-senkronize',
    title: 'Senkronize Okuma Tiyatrosu',
    shortDescription: 'Okunan cümlenin sesli olarak gelirken, kelime kelime görsel renkli vurgu ile (highlight) takip edildiği şablon.',
    activityType: ActivityType.READING_FLOW,
    category: 'okuma-akiciligi',
    targetSkills: ['otomatizasyon', 'görsel-işitsel entegrasyon'],
    ageGroups: ['8-10', '11-13'],
    profiles: ['dyslexia'],
    difficultyLevels: ['Orta'],
    suggestedGradeRange: { min: 3, max: 7 },
  ...
  },
  {
    ...
    slug: 'karaoke-heceler',
    title: 'Karaoke Heceler',
    shortDescription: 'Ekranda nota gibi kayan renkli heceleri doğru zamanda söyleyerek oluşturulan heceleme oyunu.',
    activityType: ActivityType.COLORFUL_SYLLABLE_READING,
    category: 'fonolojik-farkindalik',
    targetSkills: ['hece tanıma', 'akıcılık'],
    ageGroups: ['5-7', '8-10'],
  ...
  },
  {
    ...
    slug: '3d-hece-kupleri',
    title: 'Hece Küpleri (Sanal Manipülatif)',
    shortDescription: 'Ekranda tutup çevrilebilen 3D küplerin yüzlerindeki heceleri doğru hizalayarak kelime türetme.',
    activityType: ActivityType.SYLLABLE_WORD_BUILDER,
    category: 'fonolojik-farkindalik',
    targetSkills: ['uzamsal kelime kodlama', 'hece birleştirme'],
    ageGroups: ['8-10'],
    profiles: ['dyslexia'],
    difficultyLevels: ['Orta'],
  ...
  },
  {
    ...
    slug: 'ayna-labirenti-yon',
    title: 'Ayna Labirenti',
    shortDescription: 'Sadece doğru yöne bakan simetrik harflerin kapısını açarak labirentten çıkma etkinliği.',
    activityType: ActivityType.MIRROR_LETTERS,
    category: 'gorsel-algi',
    targetSkills: ['yön algısı', 'şekil-zemin ilişkisi'],
    ageGroups: ['5-7', '8-10'],
    profiles: ['dyslexia'],
    difficultyLevels: ['Orta'],
    suggestedGradeRange: { min: 1, max: 4 },
  ...
  },
  {
    ...
    slug: 'gramer-fabrikasi',
    title: 'Gramer Fabrikası İnşası',
    shortDescription: 'Ev inşası benzetmesiyle; özneyi temel, yüklemi çatı kabul edip parçaları sürükleyerek anlamlı cümle binası yapma.',
    activityType: ActivityType.CONCEPT_MATCH,
    category: 'yazili-anlatim',
    targetSkills: ['sentaks yapılandırma', 'cümle bütünlüğü'],
    ageGroups: ['8-10', '11-13'],
    profiles: ['dyslexia', 'mixed'],
    difficultyLevels: ['Orta', 'Zor'],
  ...
  },
  {
    ...
    slug: 'dinamik-font-tasarim',
    title: 'Özel Font Vurgulayıcı',
    shortDescription: 'Metnin tamamında sadece belli harflerin kalın, bazılarının yatık veya renkli ayarlandığı, okuma dostu uyarlama motoru.',
    activityType: ActivityType.READING_FLOW,
    category: 'okuma-akiciligi',
    targetSkills: ['görsel farkındalık', 'harf atlamayı önleme'],
  ...
  },
  {
    ...
    slug: 'modmath-sanal-defter',
    title: 'ModMath Sanal Defteri',
    shortDescription: 'Yazma zorluğu çekenler için kareli sanal tablolara dokunarak sayıları konumlandırıp işlem yapma.',
    activityType: ActivityType.BOX_MATH,
    category: 'matematik-mantigi',
    targetSkills: ['matematiksel konumlandırma', 'hizalama', 'işlem güveni'],
    ageGroups: ['8-10', '11-13'],
  ...
  },
  {
    ...
    slug: 'equatio-bloklari',
    title: 'EquatIO Uyumlu Denklem Blokları',
    shortDescription: 'Değerleri yapboz uçları ile birbirine uyumlu görsel bloklara çevirip anlamlı denklemler (formül) kilitleme.',
    activityType: ActivityType.VISUAL_ARITHMETIC,
    category: 'matematik-mantigi',
    targetSkills: ['cebirsel düşünce', 'formül mantığı'],
    ageGroups: ['11-13', '14+'],
    profiles: ['dyscalculia'],
    difficultyLevels: ['Orta', 'Zor'],
    suggestedGradeRange: { min: 6, max: 10 },
  ...
  },
  {
    ...
    slug: 'sanal-geoboard-tahtasi',
    title: 'Sanal Geoboard Modeli',
    shortDescription: 'Noktalı dijital tahtada sanal lastiklerle kenar, köşe ve alan oluşturan uzamsal hesaplama alanı.',
    activityType: ActivityType.NUMBER_SENSE,
    category: 'gorsel-algi',
    targetSkills: ['geometri algısı', 'uzamsal şekillendirme'],
    ageGroups: ['8-10', '11-13'],
    profiles: ['dyscalculia', 'mixed'],
    difficultyLevels: ['Orta'],
  ...
  },
  {
    ...
    slug: 'kesir-borsasi-simulasyonu',
    title: 'Kesir Borsası Ticker',
    shortDescription: 'Hisse senetlerinin, paranın ve pizzaların yüzde dilimleriyle ekranda borsa stili yükselip alçalması.',
    activityType: ActivityType.MONEY_COUNTING,
    category: 'matematik-mantigi',
    targetSkills: ['yüzde kavramı', 'finansal okuryazarlık', 'büyüklük algısı'],
    ageGroups: ['11-13', '14+'],
    profiles: ['dyscalculia'],
    difficultyLevels: ['Zor'],
    suggestedGradeRange: { min: 5, max: 10 },
  ...
  },
  {
    ...
    slug: 'cuisenaire-cubuk-toplami',
    title: 'Cuisenaire Çubukları Serüveni',
    shortDescription: '1 cm ile 10 cm aralığında renkli çubuklarla boşlukları tamamlayarak 10luk sayma kalıpları yaratma.',
    activityType: ActivityType.NUMBER_PATH_LOGIC,
    category: 'matematik-mantigi',
    targetSkills: ['onluk bozma', 'sayı tamamlama'],
    ageGroups: ['5-7', '8-10'],
    profiles: ['dyscalculia', 'mixed'],
    difficultyLevels: ['Kolay', 'Orta'],
    suggestedGradeRange: { min: 1, max: 4 },
  ...
  },
  {
    ...
    slug: 'analog-dijital-zaman-makinesi',
    title: 'Zaman Makinesi Arayüzü',
    shortDescription: 'Analog kadrandaki yelkovanı her çevirdiğinde dijital ve metin yazısının (ör: "Beşi on geçe") eşzamanlı değişmesi.',
    activityType: ActivityType.CLOCK_READING,
    category: 'matematik-mantigi',
    targetSkills: ['zaman entegrasyonu', 'çevrim'],
    ageGroups: ['8-10'],
  ...
  },
  {
    ...
    slug: 'piksel-buyukluk-terazisi',
    title: 'Büyüklük Terazisi (Piksel Matematik)',
    shortDescription: 'Verilen rakamların ağırlık (piksel yoğunluğu) yaptığı kefelerde sayıyı dengeleme oyunu.',
    activityType: ActivityType.CONCEPT_MATCH,
    category: 'matematik-mantigi',
    targetSkills: ['eşitlik mantığı', 'tahmin etme'],
    ageGroups: ['5-7', '8-10'],
    profiles: ['dyscalculia'],
    difficultyLevels: ['Kolay', 'Orta'],
    suggestedGradeRange: { min: 1, max: 4 },
  ...
  },
  {
    ...
    slug: 'oruntu-sifre-kasasi',
    title: 'Örüntü Şifrecisi Kasası',
    shortDescription: 'Eksik ritmik kalıpların kilitli kasaları açan bir şifre kombinasyonu gibi çözülmesi.',
    activityType: ActivityType.BOX_MATH,
    category: 'matematik-mantigi',
    targetSkills: ['ritmik sayma', 'şifre çözümü', 'problem çözme'],
    ageGroups: ['8-10', '11-13'],
    profiles: ['dyscalculia', 'adhd'],
    difficultyLevels: ['Orta', 'Zor'],
    suggestedGradeRange: { min: 3, max: 6 },
