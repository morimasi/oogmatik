...
export const LetterConnectConfig: React.FC<LetterConnectConfigProps> = ({ options, onChange }) => {
  const activityMode = (options?.activityMode as LetterConnectMode) || 'standard';
