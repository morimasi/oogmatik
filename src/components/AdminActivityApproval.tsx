 ...
 *
 * Yönetici onay/red arayüzü. Onay bekleyen etkinliklerin listesi,
 * A4 önizleme, içerik düzenleme ve onay/red akışı.
 *
 * Dark Glassmorphism tema. Inter font (admin UI).
 */
...
const AdminActivityApproval: React.FC = () => {
...
export default AdminActivityApproval;
