...
export const SmartTooltip: React.FC<SmartTooltipProps> = ({ item, pos }) => {
    ...
    return (
        <div 
            className="fixed z-[150] w-80 bg-zinc-900 border border-accent/50 shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-5 rounded-3xl pointer-events-none animate-in fade-in zoom-in-95 duration-200 backdrop-blur-xl"
            style={{ 
        ...
        >
            <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10px] font-black text-accent/70 uppercase tracking-widest">Klinik Analiz</span>
            </div>
