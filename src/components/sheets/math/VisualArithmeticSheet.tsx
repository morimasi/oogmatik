...
export const VisualArithmeticSheet = ({ data }: { data: VisualArithmeticData }) => {
    ...
    const problems = resolvedData.problems || rawData.problems || content.problems || [];
        ...
        <div className="flex flex-col font-lexend p-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 print:gap-2 print:gap-3 print:p-3 mt-10 print:mt-3 content-start flex-1">
                {(problems || []).map((prob: any, i: number) => {
                    ...
                    return (
                        <div key={i} className="p-8 print:p-2 print:p-3 border-[3px] border-zinc-900 rounded-[3rem] bg-white shadow-sm flex flex-col gap-6 print:gap-2 break-inside-avoid group hover:border-indigo-50 transition-all">
