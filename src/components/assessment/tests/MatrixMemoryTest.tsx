                ...
                >
                    {Array.from({ length: gridSize * gridSize }).map((_, i) => {
                        ...
                        if (phase === 'preview' && targetCells.includes(i)) {
                            bgClass = "bg-indigo-500 shadow-xl shadow-indigo-500/40 animate-pulse border-4 border-indigo-600";
                            extra = "scale-110";
                        }
                        ...
                        return (
                            <div
                                ...
                                className={`rounded-xl cursor-pointer transition-all duration-300 ${phase === 'preview' && targetCells.includes(i) ? '' : 'border-2 border-white/20'} ${bgClass} ${extra} ${phase === 'recall' ? 'hover:scale-105' : ''}`}
                            />
                        );
                    })}
                </div>
