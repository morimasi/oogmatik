    ...
    return (
        <div className="sk-panel" style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
            ...
            <div>
                ...
                <input type="range" className="sk-input" style={{ padding: '0.25rem' }} min={3} max={20} step={1} value={c.blockRows} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate({ blockRows: Number(e.target.value) })} />
            </div>
