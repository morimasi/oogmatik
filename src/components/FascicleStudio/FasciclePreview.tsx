    ...
    <div className="w-full max-w-4xl h-full flex flex-col bg-slate-950">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col items-center pb-20">
         ...
         <div className="w-[21cm] min-h-[29.7cm] bg-white shadow-2xl rounded-sm mb-8 flex flex-col relative overflow-hidden shrink-0">
             {/* Header Design */}
             <div className="h-64 bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-800 flex flex-col items-center justify-center p-12 text-center">
                <div className="bg-white/20 backdrop-blur-md px-4 py-1 rounded-full text-[10px] font-black text-white uppercase tracking-[0.3em] mb-4 border border-white/20">
                   Eğitim Fasikülü
                </div>
                <h1 className="text-5xl font-black text-white tracking-tighter drop-shadow-2xl leading-none">
                   {metadata.title || 'Yeni Fasikül'}
                </h1>
                <div className="mt-6 w-24 h-1 bg-white/40 rounded-full" />
             </div>
         ...
         {items.length > 0 ? items.map((item, index) => (
           <div key={item.id} className="relative group/page">
            ...
            <div className="bg-slate-900/50 backdrop-blur-md border border-white/5 p-12 rounded-3xl text-center max-w-md mt-12">
