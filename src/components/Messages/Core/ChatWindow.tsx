    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-[#050505]">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center px-6">
          ...
          <h2 className="text-xl font-bold text-white mb-1">İletişim Merkezi</h2>
          <p className="text-sm text-white/30 max-w-xs">Bir sohbet seçin veya yeni bir görüşme başlatın.</p>
        </motion.div>
      </div>
    );
  }
