      ...
      <div className="flex-1 bg-[var(--bg-paper)]/50 rounded-lg border border-[var(--border-color)] p-2 overflow-y-auto flex flex-col">
        <div className="flex-1">
            ...
            <div className="space-y-1.5 animate-in fade-in duration-200">
              ...
              <div className="grid grid-cols-2 gap-1 mt-1">
                <div className="space-y-0.5">
                  <label className="text-[7px] font-black text-[var(--text-muted)] uppercase ml-1 opacity-50">Veli</label>
                  <input
                    type="text"
                    placeholder="Ad"
                ...
                <div className="space-y-0.5">
                  <label className="text-[7px] font-black text-[var(--text-muted)] uppercase ml-1 opacity-50">Tel</label>
                  <input
                    type="tel"
                    placeholder="No"
                    className="px-1.5 py-0.5 rounded bg-[var(--bg-paper)] border border-[var(--border-color)] text-[9px] font-bold text-[var(--text-primary)] w-full outline-none"
          ...
          {activeSection === 'notifications' && (
            <div className="space-y-1.5 animate-in fade-in duration-200">
              <h3 className="text-[9px] font-black text-[var(--text-primary)] uppercase border-b border-[var(--border-color)] pb-1">Bildirim</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1 mt-1">
                {Object.entries(settings.notifications).map(([key, value]) => (
                  ...
                  >
                    <h4 className="font-bold text-[8px] text-[var(--text-secondary)] uppercase tracking-tight">{key}</h4>
                    {renderToggle(value)}
                  </div>
                ))}
              </div>
          ...
          {activeSection === 'privacy' && (
            <div className="space-y-1.5 animate-in fade-in duration-200">
              <h3 className="text-[9px] font-black text-[var(--text-primary)] uppercase border-b border-[var(--border-color)] pb-1">Gizlilik</h3>
              <div className="space-y-1 mt-1">
                {Object.entries(settings.privacy).map(([key, value]) => (
                  ...
                  >
                    <h4 className="font-bold text-[8px] text-[var(--text-secondary)] uppercase">{key}</h4>
                    {renderToggle(value)}
                  </div>
                ))}
              </div>
          ...
          {activeSection === 'modules' && (
            <div className="space-y-1.5 animate-in fade-in duration-200">
              <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-1">
                <h3 className="text-[9px] font-black text-[var(--text-primary)] uppercase">Modüller</h3>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 mt-1">
                {Object.entries(settings.modules).map(([key, value]) => (
                  ...
                  >
                    ...
                    <p className="text-[8px] font-black uppercase truncate">{key === 'iep' ? 'BEP' : key}</p>
                  </div>
                ))}
              </div>
            </div>
