        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-black tracking-tighter bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
              ANİMASYON STÜDYOSU{' '}
              <span className="text-[10px] text-indigo-400 ml-2 border border-indigo-500/30 px-1.5 py-0.5 rounded uppercase tracking-widest">
                v1.2 Ultra
              </span>
            </h1>
            <p className="text-[10px] text-slate-500 font-medium uppercase tracking-widest">
              Remotion Player Engine • AI Driven
            </p>
          </div>
        </div>
          ...
          <div className="p-6 border-t border-white/5 bg-black/20">
            <div className="flex items-start gap-4">
              ...
              <p className="text-[10px] leading-relaxed text-slate-500">
                Üretilen her animasyon %100 <b>Lexend Font</b> ve disleksi dostu renk paletiyle
                yapılandırılır.
              </p>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="text-center">
                      <h3 className="text-xl font-black tracking-tighter text-white mb-2">
                        GEMINI SAHNEYİ ÇALIŞIYOR
                      </h3>
                      <p className="text-xs text-slate-500 uppercase tracking-[0.3em]">
                        Timeline Parametreleri Hesaplanıyor...
                      </p>
                    </div>
                  </motion.div>
                )}
            ...
            <div className="p-5 rounded-2xl bg-[#0B1120] border border-white/5 space-y-4">
              ...
              <div className="space-y-3">
                {result?.props.segments.map((seg, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5 hover:border-indigo-500/30 transition-all cursor-default"
                  >
                    <div className="w-6 h-6 rounded bg-slate-800 text-[10px] flex items-center justify-center font-bold">
                      {idx + 1}
                    </div>
                    <div className="flex-1">
                      <p className="text-[11px] font-bold text-slate-200">{seg.text}</p>
                      {seg.isHighlight && (
                        <span className="text-[9px] text-indigo-400 font-black uppercase tracking-tighter">
                          Vurgu Aktif
                        </span>
                      )}
                    </div>
