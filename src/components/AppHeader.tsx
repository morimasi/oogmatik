...
export const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    <header
      className={`relative bg-[var(--bg-paper)]/80 backdrop-blur-md border-b border-[var(--border-color)] shadow-sm z-[90] transition-all duration-500 ${zenMode ? '-mt-24 opacity-0 pointer-events-none' : 'mt-0 opacity-100'}`}
    >
      <div className="w-full px-6 py-4 flex justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <HeaderDropdown label="Destek" icon="fa-circle-info">
            ...
            />
            <DropdownItem icon="fa-headset" label="Yardım Masası" onClick={onOpenFeedback} />
            <DropdownItem
