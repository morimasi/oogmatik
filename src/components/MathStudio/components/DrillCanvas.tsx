                        ...
                        {pageItems.map((op, i) => (
                            <div key={op.id} className="flex justify-center items-start">
                                {drillConfig.orientation === 'vertical'
                                    ? <OperationCardVertical op={op} fontSize={drillConfig.fontSize} fontWeight={drillConfig.fontWeight} showText={drillConfig.showTextRepresentation} themeConfig={themeConfig} index={pageIdx * perPage + i} showAnswer={drillConfig.showAnswer} />
                                    : <OperationCardHorizontal op={op} fontSize={drillConfig.fontSize} fontWeight={drillConfig.fontWeight} showText={drillConfig.showTextRepresentation} themeConfig={themeConfig} index={pageIdx * perPage + i} showAnswer={drillConfig.showAnswer} />
                                }
                            </div>
                        ))}
                    </div>
