...
export const MathStudio: React.FC<MathStudioProps> = ({ onBack, onAddToWorkbook }) => {
  ...
  const drillPagination = useDrillPagination(
    drill.generatedDrills,
    drill.drillConfig,
    pageConfig.margin
  );
  ...
  const handleSave = async () => {
    ...
    showToast(
      result.success ? 'Çalışma başarıyla kaydedildi.' : result.error || 'Hata',
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {isSidebarOpen && (
          <>
            ...
            />
            <div className="glass-panel w-80 border-r border-zinc-800/50 flex flex-col overflow-y-auto custom-scrollbar shrink-0 z-50 lg:relative lg:z-auto absolute inset-y-0 left-0 lg:static">
              <StudentPanel
