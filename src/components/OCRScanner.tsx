    ...
    try {
      ...
      if (isRetryable && remainingAttempts > 0) {
        ...
        if (errorMessage.includes('503') || errorMessage.includes('502')) {
          friendlyMessage =
            'AI servisi şu anda meşgul. Lütfen 30 saniye bekleyip tekrar deneyiniz.';
        ...
        {step === 'upload' && (
          ...
          >
            ...
            <div className="text-xs text-slate-600 mb-8 font-medium flex items-center gap-4 flex-wrap justify-center">
              <span>
                <i className="fa-solid fa-circle-info mr-1.5 text-indigo-500"></i>JPG, PNG, WEBP,
                PDF
              </span>
              <span>
                ...
                <div className="bg-black/40 rounded-3xl border border-white/5 mb-6 overflow-hidden">
                  ...
                  {isEditingBlueprint ? (
                    <textarea
                      ...
                      onChange={(e: any) => setEditedBlueprint(e.target.value)}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        max={30}
                        value={itemCount}
                        onChange={(e: any) => setItemCount(parseInt(e.target.value))}
