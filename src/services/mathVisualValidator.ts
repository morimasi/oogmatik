...
export function getVisualTypeDisplayName(tip: GrafikVeriTipi): string {
    const names: Record<GrafikVeriTipi, string> = {
        ...
        koordinat_donusum: 'Koordinat Dönüşümü',
        sayi_dogrusu: 'Sayı Doğrusu',
        kesir_modeli: 'Kesir Modeli',
        simetri: 'Simetri',
        venn_diyagrami: 'Venn Diyagramı',
        olaslik_cark: 'Olasılık Çarkı',
        kesisen_dogrular: 'Kesişen Doğrular',
        dik_kesisen_dogrular: 'Dik Kesişen Doğrular',
        paralel_dogrular: 'Paralel Doğrular',
        kup: 'Küp',
        silindir: 'Silindir',
        koni: 'Koni',
        piramit: 'Piramit',
        dikdortgenler_prizmasi: 'Dikdörtgenler Prizması',
    };
