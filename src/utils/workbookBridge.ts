...
export function legacySettingsToV2(settings: LegacyWorkbookSettings): Partial<V2WorkbookSettings> {
  return {
    ...
    year: settings.year,
    teacherNote: settings.teacherNote,
    ...
    showBackCover: settings.showBackCover,
    logoUrl: settings.logoUrl,
    aiPreface: settings.aiPreface,
    isAiGeneratedCover: settings.isAiGeneratedCover,
    aiCoverConcept: settings.aiCoverConcept,
    layoutDensity: settings.layoutDensity,
    customBackCoverNote: settings.customBackCoverNote,
