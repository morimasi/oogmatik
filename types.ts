...
export type VisualMathType = 'dots' | 'objects' | 'fingers' | 'shapes' | 'number-line' | 'mixed' | 'ten-frame' | 'domino' | 'number-line-advanced' | 'estimation-jar' | 'spatial-cubes' | 'number-bond' | 'dice' | 'blocks';
