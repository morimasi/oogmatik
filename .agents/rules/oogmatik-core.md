...
> **Keyword gerekmez — Her istemde niyet analizi yap, tüm ilgili ajanları otomatik devreye sok.**

```
Her istemde (keyword aramadan önce) şu soruları sor:
...
"Bunu düzelt", "ekle şunu", "tamam yap" gibi kısa istemler de dahil — niyet analizi zorunludur.
