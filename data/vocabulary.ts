...
export const TR_VOCAB = {
  ...
  fruits_veggies: [
    ...
    "domates", "salatalık", "biber", "patlıcan", "kabak", "fasulye", "bezelye", "bamy", "ıspanak", "pırasa",
  ...
  school: [
    ...
    "laboratuvar", "kütüphane", "müdür", "nöbetçi", "ziş", "koridor", "bahçe", "tören", "bayrak", "istiklal",
    "kırtasiye", "çanta", "suluk", "beslenme", "servis", "kolej", "üniversite", "fakülte", "kampüs", "diploma"
  ],
  emotions: [
    "mutlu", "üzgün", "kızgın", "şaşkın", "korkmuş", "heyecanlı", "endişeli", "gururlu", "utanmış", "sevgi",
    "nefret", "özlem", "kıskançlık", "hayalkırıklığı", "pişmanlık", "umutlu", "karamsar", "iyimser", "yalnız", "huzurlu",
    "gergin", "rahat", "yorgun", "dinç", "isteksiz", "hevesli", "meraklı", "ilgisiz", "sempatik", "antipatik",
    "sevinçli", "kederli", "öfkeli", "sakin", "coşkulu", "bezgin", "bıkkın", "memnun", "hoşnut", "küskün"
  ],
  space: [
    ...
    "uydu", "roket", "mekik", "astronot", "kozmonot", "teleskop", "gözlemevi", "krater", "meteor", "kuyrukluyıldız",
    "yörünge", "çekim", "atmosfer", "oksijen", "nitrojen", "hidrojen", "helyum", "karadelik", "süpernova", "bulutsu"
  ],
  nature: [
  ...
  // ZORLUK SEVİYELERİ İÇİN ÖZEL LİSTELER
  easy_words: [ // 3-4 Harfli, Somut
  ...
  medium_words: [ // 5-6 Harfli, Günlük
  ...
  hard_words: [ // 7-9 Harfli, Soyut/Karmaşık
  ...
  expert_words: [ // 10+ Harfli, Akademik, Nadir
    "muvaffakiyet", "çekoslovakyalılaştıramadıklarımızdanmısınız", "afyonkarahisarlılaştırabildiklerimizdenmişsinizcesine", // Şaka bir yana, uzun kelimeler
